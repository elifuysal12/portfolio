...
@media (max-width:820px){{
  body{{overflow:auto}}
  /* size to the screen, not to the viewport: flex:1 here leaves a acre of
     empty room between a small screen and the note under it */
  .stage{{flex:0 0 auto;padding:14px 10px 10px;justify-content:flex-start}}
